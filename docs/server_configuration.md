...
- When a watched book’s voice channel becomes active (reaches the participant threshold), you will receive a **DM notification**
...
### `/watch list`
- あなたのウォッチリストを表示します
- ウォッチ中の本のボイスチャンネルがアクティブ（参加者が一定人数）になると **DM 通知**が届きます
### `/watch add <ISBN1> <ISBN2> ...`
