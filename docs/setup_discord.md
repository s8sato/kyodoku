...
2. In the target Discord server, open a text channel and type `/isbn` or `/watch`. The Discord client should autocomplete the command if the bot registered correctly.
