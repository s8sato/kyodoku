...
fn desired_posts(config: &Config) -> (String, String) {
    let english = format!(
        concat!(
            ...
            "## :warning: Spoiler-Friendly Posts\n",
            ...
            "After finishing, I'm still thinking about how the author ||leaves room for readers to interpret the ending\n",
            "through sparse descriptions and the placement of symbolic items in the last scene||. Overall, an amazing read!\n",
            "```\n\n",
